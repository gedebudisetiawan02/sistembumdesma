...
$pdf->SetX(4);
$pdf->Image('../logo.png',2,1.3,2,1.6);
$pdf->SetX(4); 
$pdf->MultiCell(19.5,0.5,'  BADAN USAHA MILIK DESA BERSAMA(BUMDESMA) SETYA DHARMA SHANTI',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'  Alamat : Jalan kartini No. 4A Singaraja',0,'L');
$pdf->SetX(4);
