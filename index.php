...
<head>
  ...
  <title>BUMDES SETYA DHARMA SHANTI</title>
...
<section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      ?>
            ...
            <!--logo start-->
            <a href="#" class="logo">BUMDES SETYA DHARMA SHANTI | <?php echo $_SESSION['level'];?></a>
            <!--logo end-->
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              if($_SESSION['level']=='admin')
              {
                ?>
                  ...
                  <p class="centered"><a href="#"><img src="logo.png" class="img-circle" width="60"></a></p>
            ...
            <li><a href="index.php?pilih=4.3"><i class="glyphicon glyphicon-user"></i> Setting User</a></li>
              ...
              ?>
              <hr>
              <center>BUMDES SETYA DHARMA SHANTI</a>
              <br><center><p>Created by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>Alfa Prima</a></p></center>
