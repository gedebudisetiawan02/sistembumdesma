    <template id="t_jenis_pinjamEdit">
        <section class="page-component">
            <div v-if="showheader" class="bg-light p-3 mb-3">
                <div class="container">
                    <div class="row ">
                        <div  class="col-12 comp-grid" :class="setGridSize">
                            <h3 class="record-title">Edit  T Jenis Pinjam</h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row ">
                        <div  class="col-md-7 comp-grid" :class="setGridSize">
                            <div  class=" animated fadeIn">
                                <form  v-show="!loading" enctype="multipart/form-data" @submit="update()" class="form form-default" :action="'t_jenis_pinjam/edit/' + data.id" method="post">
    ...
    <script>
	var T_Jenis_PinjamEditComponent = Vue.component('t_jenis_pinjamEdit', {
		template : '#t_jenis_pinjamEdit',
		...
		props: {
			...
			routename : {
				type : String,
				default : 't_jenis_pinjamedit',
			},
			apipath : {
				type : String,
				default : 't_jenis_pinjam/edit',
			},
		},
		data: function() {
			return {
				data : { kode_jenis_pinjam: '',nama_pinjaman: '',lama_angsuran: '',maks_pinjam: '',bunga: '',u_entry: '',tgl_entri: '', },
			}
		},
		computed: {
			pageTitle: function(){
				return 'Edit  T Jenis Pinjam';
			},
		},
		methods: {
