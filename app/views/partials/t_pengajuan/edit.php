    <template id="t_pengajuanEdit">
        <section class="page-component">
            <div v-if="showheader" class="bg-light p-3 mb-3">
                <div class="container">
                    <div class="row ">
                        <div  class="col-12 comp-grid" :class="setGridSize">
                            <h3 class="record-title">Edit  T Pengajuan</h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row ">
                        <div  class="col-md-7 comp-grid" :class="setGridSize">
                            <div  class=" animated fadeIn">
                                <form  v-show="!loading" enctype="multipart/form-data" @submit="update()" class="form form-default" :action="'t_pengajuan/edit/' + data.id" method="post">
    ...
    <script>
	var T_PengajuanEditComponent = Vue.component('t_pengajuanEdit', {
		template : '#t_pengajuanEdit',
		...
		props: {
			...
			routename : {
				type : String,
				default : 't_pengajuanedit',
			},
			apipath : {
				type : String,
				default : 't_pengajuan/edit',
			},
		},
		data: function() {
			return {
				data : { tgl_pengajuan: '',kode_anggota: '',kode_jenis_pinjam: '',besar_pinjam: '',tgl_acc: '',status: '', },
			}
		},
		computed: {
			pageTitle: function(){
				return 'Edit  T Pengajuan';
			},
		},
		methods: {
