    <template id="t_anggotaAdd">
        <section class="page-component">
            <div v-if="showheader" class="bg-light p-3 mb-3">
                <div class="container">
                    <div class="row ">
                        <div  class="col-12 comp-grid" :class="setGridSize">
                            <h3 class="record-title">Add New T Anggota</h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row ">
                        <div  class="col-md-7 comp-grid" :class="setGridSize">
                            <div  class=" animated fadeIn">
                                <form enctype="multipart/form-data" @submit="save" class="form form-default" action="t_anggota/add" method="post">
    ...
    <script>
	var T_AnggotaAddComponent = Vue.component('t_anggotaAdd', {
		template : '#t_anggotaAdd',
		mixins: [AddPageMixin],
		props:{
			pagename : {
				type : String,
			...
			routename : {
				type : String,
				default : 't_anggotaadd',
			},
			apipath : {
				type : String,
				default : 't_anggota/add',
			},
		},
		data : function() {
			return {
		...
		methods: {
			...
			resetForm : function(){
				this.data = {kode_anggota: '',kode_tabungan: '',nama_anggota: '',alamat_anggota: '',jenis_kelamin: '',pekerjaan: '',tgl_masuk: '',telp: '',tempat_lahir: '',tgl_lahir: '',status: '',u_entry: '',tgl_entri: '',};
