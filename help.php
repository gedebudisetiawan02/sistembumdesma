...
<div class="row mt">
 ...
 <div class="form-panel" style="border-left:5px solid#d9534f;border-right:5px solid#d9534f;">
  ...
  <div class="form-panel" style="border-left:5px solid#d9534f;border-right:5px solid#d9534f;">
    ...
    <p>Saat proses terima otomatis data akan masuk sebagai pinjaman yang sah</p>
  ...
  <div class="form-panel" style="border-left:5px solid#d9534f;border-right:5px solid#d9534f;">
    ...
    <p>Terdapat laporan pinjaman<br>1. Semua Pinjaman : ini berisi semua pinjamn yang dilakukan<br>2. jatuh tempo : apabila tanggal sekarang = tanggal jatuh tempo<br>3. telat : apabila tanggal sekarang melebihi tanggal jatuh tempo dan dikali 1000/perhari(tergantung)</p>
  </div>
  <div class="form-panel" style="border-left:5px solid#d9534f;border-right:5px solid#d9534f;">
  ...
  <div class="form-panel" style="border-left:5px solid#d9534f;border-right:5px solid#d9534f;">
    ...
    <p>Mengelola siapa saja yang dapat mengakses program</p>
  </div>
  </div>
 </div>
